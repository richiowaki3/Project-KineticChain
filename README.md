...
### 📚 ドキュメント＆連携ガイド
- **[VRM 49ノード＆3機能連鎖 実装計画書](docs/IMPLEMENTATION_PLAN.md)**: 3系統の分離定義・骨格トポロジー
- **[辞書チーム向け ADU活用ガイド](docs/DICTIONARY_GUIDE.md)**: オノマトペ（ピシッ・ズシン・サッ等）とのマッピング仕様
- **[サンプルデータ＆クエリスクリプト](samples/)**: 即座に試せるADU JSONと検索Pythonコード
